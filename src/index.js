...
const SKILLS = [
  ...
  },
  {
    ...
    description:
      '当用户要求制作 PPT、演示文稿、汇报 PPT、课件、宣讲材料、把材料转成 PPT、做幻灯片，或要求可编辑原生 PPT、多版式（16:9/4:3/小红书/竖版/A4）输出时，使用深知可信PPT。约束 SVG 逐页创作 + 确定性编译为原生可编辑 PowerPoint（真实形状/文本/图表/表格，非整页图片）；素材检索经深知可信工作台 MCP（trusted_search）全程可溯源，交付 .pptx 与溯源核验报告。注意区分：写文字材料/Word/红头用公文写作 skill；只检索材料不成稿用可信搜索 skill。',
  },
  {
    name: 'dknowc-official-doc-writer',
    description:
      '当用户要求写一份正式文稿、成稿或报告——如"帮我写一份××分析报告"、"写一份××调研报告"、"写一份××政策分析报告"、"写一份××工作报告/总结/方案/汇报材料"，或要求起草通知、请示、报告、函、复函、批复、会议纪要、通报、通告、公告、意见、管理办法、发言稿、讲话稿、经验材料等正式文种时，使用深知公文写作。正式交付支持生成 Word 文档，用户明确需要时可生成红头文件；涉及政策依据时可内部通过深知可信搜索（MCP）获取素材并生成溯源核验报告，正式写作前经 MCP doc_outline 获取范文大纲参考。若用户只是要求检索/查证政策原文或做深度搜索核验而不是把素材写成成稿，应改用深知可信搜索。',
  },
]

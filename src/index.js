...
const SKILLS = [
  ...
  },
  {
    ...
    description:
      '当用户要求写一份正式文稿、成稿或报告——如"帮我写一份××分析报告"、"写一份××调研报告"、"写一份××政策分析报告"、"写一份××工作报告/总结/方案/汇报材料"，或要求起草通知、请示、报告、函、复函、批复、会议纪要、通报、通告、公告、意见、管理办法、发言稿、讲话稿、经验材料等正式文种时，使用深知公文写作。正式交付支持生成 Word 文档，用户明确需要时可生成红头文件；涉及政策依据时可内部通过深知可信搜索（MCP）获取素材并生成溯源核验报告。若用户只是要求检索/查证政策原文或做深度搜索核验而不是把素材写成成稿，应改用深知可信搜索。',
  },
]

...
def _dsh_default_output_dir() -> str:
    ...
    return str(Path(_ws).resolve() / "official-docs" / "output")
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default=_dsh_default_output_dir(), help="未传 --output 时的输出目录")
